...
pkgdatadir = $(datadir)/fenc
pkgincludedir = $(includedir)/fenc
pkglibdir = $(libdir)/fenc
pkglibexecdir = $(libexecdir)/fenc
...
DIST_COMMON = README $(am__configure_deps) $(library_include_HEADERS) \
	...
	$(srcdir)/config.h.in $(srcdir)/param $(top_srcdir)/configure \
...
LINK = $(LIBTOOL) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) \
	...
	$(LDFLAGS) -o $@
SOURCES = $(libfenc_la_SOURCES)
DIST_SOURCES = $(libfenc_la_SOURCES)
...
ABI = 
ACLOCAL = ${SHELL} /home/hieu/Downloads/libfenc/missing --run aclocal-1.11
ALLOCA = 
AMTAR = ${SHELL} /home/hieu/Downloads/libfenc/missing --run tar
AR = ar
AS = as
AUTOCONF = ${SHELL} /home/hieu/Downloads/libfenc/missing --run autoconf
AUTOHEADER = ${SHELL} /home/hieu/Downloads/libfenc/missing --run autoheader
AUTOMAKE = ${SHELL} /home/hieu/Downloads/libfenc/missing --run automake-1.11
AWK = mawk
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -Wall -W -Wfloat-equal -lm -Wpointer-arith -Wcast-align -Wredundant-decls -Wendif-labels -Wshadow -pipe -ffast-math -U__STRICT_ANSI__ -g -O2 -DDEBUG
CPP = gcc -E
CPPFLAGS = 
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/hieu/Downloads/libfenc/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
OBJDUMP = objdump
...
OTOOL64 = 
PACKAGE = fenc
PACKAGE_BUGREPORT = libfenc-devel at googlegroups dot com
PACKAGE_NAME = fenc
PACKAGE_STRING = fenc 0.2.0
PACKAGE_TARNAME = fenc
PACKAGE_URL = 
...
STRIP = strip
VERSION = 0.2.0
YACC = ${SHELL} /home/hieu/Downloads/libfenc/missing --run bison -y
YFLAGS = 
abs_builddir = /home/hieu/Downloads/libfenc
abs_srcdir = /home/hieu/Downloads/libfenc
abs_top_builddir = /home/hieu/Downloads/libfenc
abs_top_srcdir = /home/hieu/Downloads/libfenc
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /home/hieu/Downloads/libfenc/install-sh
...
am--refresh:
	@:
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am $(srcdir)/param $(am__configure_deps)
	@for dep in $?; do \
...
libfenc.la: $(libfenc_la_OBJECTS) $(libfenc_la_DEPENDENCIES) 
	$(libfenc_la_LINK) -rpath $(libdir) $(libfenc_la_OBJECTS) $(libfenc_la_LIBADD) $(LIBS)
...
include ./$(DEPDIR)/libfenc_WatersSimpleCP.Plo
include ./$(DEPDIR)/libfenc_group_params.Plo
include ./$(DEPDIR)/libfenc_utils.Plo
